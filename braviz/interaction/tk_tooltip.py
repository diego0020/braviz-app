...
class ToolTip( Toplevel ):
    ...
    def move( self, event ):
        ...
        try:
            self.msgVar.set( self.msgFunc(event) )                                   # Try to call the message function.  Will not change the message if the message function is None or the message function fails
