...
def boundingBoxIntesection(box1,box2):
    ...
    for i in range(3):
        #      2----[1]------2------1                                   1-----[2]-----1------2
        if (box1[2*i] >= box2[2*i] and box1[2*i] <= box2[2*i+1]) or (box2[2*i] >= box1[2*i] and box2[2*i] <= box1[2*i+1]) :
        #      2----[1]-----1-------2                                   1-----[2]-----2-------1 
            pass
        else:
